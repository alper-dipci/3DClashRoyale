...
namespace StarterAssets
{
	...
	{
		public static FirstPersonController LocalInstance;
        ...
        public override void OnNetworkSpawn()
        {
			...
			escapeUi = GameObject.FindWithTag("escapeUi");
			...
			if (cmVirtual == null)
			{
				Debug.Log("cmVirtual null");
			}
			else
			{
				cmVirtual.Follow = CinemachineCameraTarget.transform;
			}
			base.OnNetworkSpawn();
        }
        ...
        private void Update()
		{
			...
			if (Input.GetKeyDown(KeyCode.Escape)) {
                if (escapeUi!= null)
                {
					GameObject parent = escapeUi.transform.GetChild(0).gameObject;

					parent.SetActive(!parent.active);

					Cursor.lockState = parent.active ?  CursorLockMode.None : CursorLockMode.Locked;
				}
			}
